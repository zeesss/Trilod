...
var CheckBoxEditorModule_1;
const core_1 = require("@angular/core");
const forms_1 = require("@angular/forms");
const common_1 = require("@angular/common");
const checkbox_editor_component_1 = require("./checkbox-editor.component");
let CheckBoxEditorModule = CheckBoxEditorModule_1 = class CheckBoxEditorModule {
    static forRoot() {
        return {
            ngModule: CheckBoxEditorModule_1,
        };
    }
};
CheckBoxEditorModule = CheckBoxEditorModule_1 = __decorate([
    core_1.NgModule({
