...
var CheckListEditorModule_1;
const core_1 = require("@angular/core");
const forms_1 = require("@angular/forms");
const common_1 = require("@angular/common");
const checklist_editor_component_1 = require("./checklist-editor.component");
let CheckListEditorModule = CheckListEditorModule_1 = class CheckListEditorModule {
    static forRoot() {
        return {
            ngModule: CheckListEditorModule_1,
        };
    }
};
CheckListEditorModule = CheckListEditorModule_1 = __decorate([
    core_1.NgModule({
