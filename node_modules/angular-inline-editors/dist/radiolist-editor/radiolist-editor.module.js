...
var RadioListEditorModule_1;
const core_1 = require("@angular/core");
const forms_1 = require("@angular/forms");
const common_1 = require("@angular/common");
const radiolist_editor_component_1 = require("./radiolist-editor.component");
let RadioListEditorModule = RadioListEditorModule_1 = class RadioListEditorModule {
    static forRoot() {
        return {
            ngModule: RadioListEditorModule_1,
        };
    }
};
RadioListEditorModule = RadioListEditorModule_1 = __decorate([
    core_1.NgModule({
