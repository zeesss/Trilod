...
let DateEditorModule = DateEditorModule_1 = class DateEditorModule {
    static forRoot() {
        return {
            ngModule: DateEditorModule_1,
        };
    }
};
DateEditorModule = DateEditorModule_1 = __decorate([
    core_1.NgModule({
        imports: [
