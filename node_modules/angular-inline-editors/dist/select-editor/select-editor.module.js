...
let SelectEditorModule = SelectEditorModule_1 = class SelectEditorModule {
    static forRoot() {
        return {
            ngModule: SelectEditorModule_1,
        };
    }
};
SelectEditorModule = SelectEditorModule_1 = __decorate([
    core_1.NgModule({
        imports: [
