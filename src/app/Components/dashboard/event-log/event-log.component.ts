...
export class EventLogComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // this.rest.getEventLogById(localStorage.getItem("editSessionId")).subscribe((data: {}) => {
    //   // debugger;
    ...
    // }
    //       );
    //       this.rest.getEventLogBySessionId(localStorage.getItem("editSessionId")).subscribe((data: {}) => {
    //         // debugger;
    //           //      alert(JSON.stringify(data));
  ...
  onChangeAudit(event) {
    ...
    console.log(this.audit);
          this.rest.getEventLogBySessionId(this.audit).subscribe((data: {}) => {
  ...
  changeRule(event: any){
    ...
    //alert(br.id);
    //this.rest.getEventLogFindById(br.id).subscribe((data: {}) => {
      this.rest.getEventLogFindById(selectField).subscribe((data: {}) => {
      // debugger;
        //      alert(JSON.stringify(data));
